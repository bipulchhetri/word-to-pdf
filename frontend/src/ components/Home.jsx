...
//         "https://word-to-pdf-zm6v.onrender.com/convert",
//         formData,
//         {
//           responseType: "blob",
//         }
...
//   return (
//     <>
//   <div className="max-w-screen-2xl container md:px-40 body">
//         <div className="flex h-150 items-center justify-center">
//           <div className=" border-2 border-dashed md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg">
...
//                 className="text-white bg-pink-500 hover:bg-pink-700 disabled:bg-gray-400 disabled:pointer-events-none duration-300 font-bold px-6 py-3 rounded-lg"
//               >
//                 Convert File
//               </button>
//               {convert && (
...
const Home = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Show success toast
      showToast("Conversion Completed Successfully ✅", "green");
      ...
      <div className="flex h-150 items-center justify-center">
        <div className="border-2 border-dashed md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <label
              htmlFor="FileInput"
              className="w-full flex items-center justify-center px-4 py-6 bg-gray-100 text-gray-700 rounded-lg shadow-lg cursor-pointer border-blue-300 hover:bg-pink-700 duration-300 hover:text-white"
            >
              <FaFileWord className="text-3xl mr-3" />
              <span className="text-2xl mr-2 ">
                {selectedFile ? selectedFile.name : "Choose File"}
